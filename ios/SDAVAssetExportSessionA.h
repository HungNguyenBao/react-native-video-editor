...
@protocol SDAVAssetExportSessionADelegate;
...
@interface SDAVAssetExportSessionA : NSObject

@property (nonatomic, weak) id<SDAVAssetExportSessionADelegate> delegate;
...
@protocol SDAVAssetExportSessionADelegate <NSObject>

- (void)exportSession:(SDAVAssetExportSessionA *)exportSession renderFrame:(CVPixelBufferRef)pixelBuffer withPresentationTime:(CMTime)presentationTime toBuffer:(CVPixelBufferRef)renderBuffer;
